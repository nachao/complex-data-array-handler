...
// Return {array}
function mateDepth(method, condition, datas, result, paths, keys, key) {
  ...
  if (datas && [Function, Object, Array].indexOf(datas.constructor) > -1) {
    ...
    each(datas, function(key, data) {
      if (typeof data == 'object') {
        mateDepth(method, condition, data, result, newPaths, newKeys, key)
      }
    })
  }
}
